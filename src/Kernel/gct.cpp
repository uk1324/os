...
void gdt_init()
{
	...
	gdt.entries[0] = gdt_create_entry(0, 0, 0, 0);
	gdt.entries[1] = gdt_create_entry(0, 0xFFFF, 0b10011010, 0b0000);
	gdt.entries[2] = gdt_create_entry(0, 0xFFFF, 0b10010010, 0b0000); 
	// gdt.entries[1] = gdt_create_entry(0, 0xFFFF, 0b10011010, 0b0000);
	// gdt.entries[2] = gdt_create_entry(0, 0xFFFF, 0b10010010, 0b0000); 
	// gdt.entries[3] = gdt_create_entry(0, 0xFFFFFFFF, 0b10011010, 0b0100);
	// gdt.entries[4] = gdt_create_entry(0, 0xFFFFFFFF, 0b10010010, 0b0110);
	// gdt.entries[5] = gdt_create_entry(0, 0, 0b10011010, 0b0000);
	// gdt.entries[6] = gdt_create_entry(0, 0, 0b10010010, 0b0010);
